## specific notes
This application includes basic boiler plate for react js app.
It shows how to create Components/ how to navigate between pages.

Navigating between pages uses "react-router-dom" api.



## below content is default notes
